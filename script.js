...
const translations = {
  en: {
    ...
    "hero.eyebrow": "Personal finances, without the spreadsheets",
    "hero.title": "AI‑assisted accounting on your desktop.",
    "hero.subtitle":
      "Kivana helps you organize transactions, bills, and documents with professional reporting and optional AI assistance. Your data stays on your device, with portable backups when you need them.",
    "hero.ctaPrimary": "Get Kivana",
    ...
    "download.ctaPrimary": "Download (coming soon)",
    "download.ctaSecondary": "Back to top",
    "download.note":
      "Replace “coming soon” with your real download links when you’re ready.",
  ...
  de: {
    ...
    "nav.faq": "FAQ",
    "nav.download": "Download",
    "hero.eyebrow": "Finanzen ohne Tabellenkalkulation",
    "hero.title": "KI‑gestützte Buchhaltung auf dem Desktop.",
    "hero.subtitle":
      "Kivana hilft Ihnen, Transaktionen, Rechnungen und Dokumente mit professionellen Auswertungen und optionaler KI zu organisieren. Ihre Daten bleiben auf Ihrem Gerät – mit portablen Backups.",
    "hero.ctaPrimary": "Kivana holen",
    "hero.ctaSecondary": "Pläne ansehen",
    ...
    "download.ctaPrimary": "Download (bald verfügbar)",
    "download.ctaSecondary": "Nach oben",
    "download.note":
      "Ersetzen Sie „bald verfügbar“, sobald Download‑Links bereitstehen.",
  ...
  fr: {
    ...
    "hero.eyebrow": "Vos finances sans tableurs",
    "hero.title": "Comptabilité assistée par IA sur votre bureau.",
    "hero.subtitle":
      "Kivana organise transactions, factures et documents avec des rapports professionnels et une IA optionnelle. Vos données restent sur votre appareil, avec des sauvegardes portables.",
    "hero.ctaPrimary": "Obtenir Kivana",
    "hero.ctaSecondary": "Voir les offres",
    ...
    "download.ctaPrimary": "Télécharger (bientôt)",
    "download.ctaSecondary": "Haut de page",
    "download.note": "Remplacez “bientôt” quand vos liens seront prêts.",
  ...
  es: {
    ...
    "hero.eyebrow": "Finanzas sin hojas de cálculo",
    "hero.title": "Contabilidad asistida por IA en tu escritorio.",
    "hero.subtitle":
      "Kivana organiza transacciones, facturas y documentos con informes profesionales y una IA opcional. Tus datos se quedan en tu dispositivo, con copias de seguridad portátiles.",
    "hero.ctaPrimary": "Obtener Kivana",
    ...
    "download.ctaPrimary": "Descargar (próximamente)",
    "download.ctaSecondary": "Volver arriba",
    "download.note": "Cambia “próximamente” cuando tengas enlaces reales.",
  ...
  it: {
    ...
    "nav.faq": "FAQ",
    "nav.download": "Download",
    "hero.eyebrow": "Finanze senza fogli di calcolo",
    "hero.title": "Contabilità assistita dall’IA sul desktop.",
    "hero.subtitle":
      "Kivana organizza transazioni, fatture e documenti con report professionali e IA opzionale. I dati restano sul tuo dispositivo, con backup portatili.",
    "hero.ctaPrimary": "Ottieni Kivana",
    "hero.ctaSecondary": "Vedi piani",
    ...
    "download.ctaPrimary": "Download (a breve)",
    "download.ctaSecondary": "Torna su",
    "download.note": "Sostituisci “a breve” quando i link saranno pronti.",
  ...
  pt: {
    ...
    "nav.faq": "FAQ",
    "nav.download": "Download",
    "hero.eyebrow": "Finanças sem planilhas",
    "hero.title": "Contabilidade com IA no seu desktop.",
    "hero.subtitle":
      "O Kivana organiza transações, faturas e documentos com relatórios profissionais e IA opcional. Seus dados ficam no seu dispositivo, com backups portáteis.",
    "hero.ctaPrimary": "Obter Kivana",
    ...
    "download.ctaPrimary": "Download (em breve)",
    "download.ctaSecondary": "Voltar ao topo",
    "download.note": "Troque “em breve” quando os links estiverem prontos.",
  ...
  nl: {
    ...
    "nav.faq": "FAQ",
    "nav.download": "Download",
    "hero.eyebrow": "Financiën zonder spreadsheets",
    "hero.title": "AI‑ondersteunde boekhouding op je desktop.",
    "hero.subtitle":
      "Kivana organiseert transacties, facturen en documenten met professionele rapporten en optionele AI. Je data blijft op je apparaat, met draagbare back-ups.",
    "hero.ctaPrimary": "Kivana downloaden",
    "hero.ctaSecondary": "Bekijk plannen",
    ...
    "download.ctaPrimary": "Download (binnenkort)",
    "download.ctaSecondary": "Naar boven",
    "download.note": "Vervang “binnenkort” zodra links klaar zijn.",
  ...
  pl: {
    ...
    "hero.eyebrow": "Finanse bez arkuszy",
    "hero.title": "Księgowość wspierana przez AI na komputerze.",
    "hero.subtitle":
      "Kivana porządkuje transakcje, faktury i dokumenty dzięki profesjonalnym raportom i opcjonalnemu AI. Dane zostają na Twoim urządzeniu, z przenośnymi kopiami zapasowymi.",
    "hero.ctaPrimary": "Pobierz Kivana",
    "hero.ctaSecondary": "Zobacz plany",
    ...
    "download.ctaPrimary": "Pobierz (wkrótce)",
    "download.ctaSecondary": "Do góry",
    "download.note": "Zmień “wkrótce”, gdy linki będą gotowe.",
  ...
  nb: {
    ...
    "hero.eyebrow": "Personlig økonomi, uten regneark",
    "hero.title": "AI‑assistert regnskap på skrivebordet.",
    "hero.subtitle":
      "Kivana hjelper deg å organisere transaksjoner, regninger og dokumenter med profesjonell rapportering og valgfri AI‑assistanse. Dataene dine blir på enheten, med portable sikkerhetskopier når du trenger det.",
    "hero.ctaPrimary": "Skaff Kivana",
    "hero.ctaSecondary": "Se planer",
    ...
    "download.ctaPrimary": "Last ned (kommer snart)",
    "download.ctaSecondary": "Til toppen",
    "download.note":
      "Bytt ut “kommer snart” med ekte nedlastingslenker når du er klar.",
